var model_json, scene, scene2, renderer, camera, controls, groups, visibility, group, insetwidth, insetheight, size, travel, pathPoints, pathPointsFloors, window_width;
...
function resize() {
    ...
    // insetwidth = modelContainer.clientWidth / 3;
    // insetheight = modelContainer.clientHeight / 3;
    // camera_first.aspect = insetwidth/insetheight;
    // camera_first.updateProjectionMatrix();
}
...
function render_model(model) {
    ...
    floorBtn = document.createElement("select");
    floorBtn.classList.add("floor-btn");
    floorBtn.setAttribute("id", "currentFloor");
    floorBtn.setAttribute("name", "Floor");
    floorBtn.addEventListener("change", changeFloor);
    floorHeading = document.createElement("h2");
    floorHeading.innerHTML = "Floor Changer";
    floorHeading.classList.add("floor-heading");
    floorBtnContainer.appendChild(floorHeading);
    floorBtnContainer.appendChild(floorBtn);
    navPanel.appendChild(floorBtnContainer);
    
    roomHeading = document.createElement("h2");
    roomHeading.innerHTML = "Navigation";
    roomHeading.classList.add("room-heading");
    room1 = document.createElement("input");
    room1.classList.add("room-input");
    room1.placeholder = "Start...";
    room2 = document.createElement("input");
    room2.classList.add("room-input");
    room2.placeholder = "Destination...";
    roomsContainer = document.createElement("div");
    roomsContainer.classList.add("rooms-container");
    roomsContainer.appendChild(roomHeading);
    roomsContainer.appendChild(room1);
    roomsContainer.appendChild(room2);
    navPanel.appendChild(roomsContainer);

    findPathContainer = document.createElement("div");
    findPathContainer.classList.add("find-path-container");
    findPathButton = document.createElement('button');
    findPathButton.classList.add("find-path");
    findPathButton.innerHTML = "Find path";
    findPathButton.addEventListener("click", findPath);
    findPathContainer.appendChild(findPathButton);
    navPanel.appendChild(findPathContainer);
    
    pauseContainer = document.createElement('div');
    pauseText = document.createElement("p");
    ...
    navPanel.appendChild(pauseContainer);
    ...
    togglePanelBtn.classList.add("toggle-panel");
    togglePanelBtn.innerHTML = "<";
    togglePanelBtn.addEventListener("click", toggle_panel);
    modelContainer.appendChild(togglePanelBtn);
